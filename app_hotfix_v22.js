...
async function syncPicksToServerForced(){
  // Same as syncPicksToServer but bypasses the throttle.
  // Used after historical re-settlement to push corrected results immediately.
  lastSyncAt = 0; // reset throttle
  syncInProgress = false; // clear any stale lock
