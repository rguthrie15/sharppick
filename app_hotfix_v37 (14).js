...
async function publishToLeaderboard(){
  ...
  try {
    ...
    console.log('[SharpPick] publishToLeaderboard formula debug:',
      'picks:', s90picks.length, 'w90:', w90, 'l90:', l90,
      'winRate:', winRate90_lb.toFixed(1), 'roi:', roi90,
      'wrScore:', _winRateScore_lb.toFixed(1), 'roiScore:', _roiScore_lb.toFixed(1),
      'volMult:', _volMult_lb.toFixed(2), 'SR:', sharpRating);
