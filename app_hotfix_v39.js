...
async function generateAIBreakdown() {
  ...
  cardEl.innerHTML = `
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:12px">
      ...
      <div>
        ...
        <div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--muted);letter-spacing:1.5px">ANALYZING YOUR LAST 10 PICKS…</div>
      </div>
    </div>
  ...
  // Build pick summary for the last 10 settled picks
