...
async function publishToLeaderboard(){
  ...
  try {
    ...
    console.log('[SharpPick] lb-debug picks=' + s90picks.length + ' w=' + w90 + ' l=' + l90 + ' wr=' + winRate90_lb.toFixed(1) + ' roi=' + roi90 + ' wrScore=' + _winRateScore_lb.toFixed(1) + ' roiScore=' + _roiScore_lb.toFixed(1) + ' vol=' + _volMult_lb.toFixed(2) + ' SR=' + sharpRating);
