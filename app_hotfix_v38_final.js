...
function renderAnalyticsView(){
  ...
  <div id="aiBreakdownCard" class="analysis-card" style="margin-bottom:8px;border:1px solid rgba(0,229,255,.2);background:rgba(0,229,255,.03)"></div>
  <script>setTimeout(()=>generateAIBreakdown(),100);<\/script>` : ''}
